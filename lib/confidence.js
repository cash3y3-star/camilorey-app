...
function computeConfidence({
  ...
  const WEIGHTS = { rating: ratingWeight, streak: 0.05, h2h: 0.1, alt: altWeight, odds: oddsWeight };
  ...
  const raw =
    ...
    oddsScore * WEIGHTS.odds; // rango aprox -1 a 1
  ...
  return {
    ...
    factors: { ratingScore, streakScore, h2hScore, altScore, oddsScore, weights: WEIGHTS }
  };
}
